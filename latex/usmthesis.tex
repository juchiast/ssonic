...
\usepackage{pdfpages}
\usepackage{geometry}
\geometry{a4paper, portrait, left=3cm,right=2cm,top=2cm,bottom=2cm}
...
% Your Name
\author{DO HOANG ANH DUY - 1612847}

% English title of your thesis
\title{Supersonic SNARKs and applications}
...
\degreetype{BACHELOR OF SCIENCE - HONORS PROGRAM}
% \degreetype{Master of Science}
\lecturer{Assoc. Prof. NGUYEN DINH THUC}
...
\include{table-of-terms} \clearpage

\renewcommand{\listtheoremname}{List of Algorithms}
\listoftheorems[ignoreall,show={protocol,ealgorithm}]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
